# Author: Jackie Xu
# Date: 11/20/2014
# Purpose: Introduction to OOP, writing a Calendar program using OOP
# ==========================================================================
...
class Date:
    ...
    def displayCalendar(self):
        ...
        objCalendar.create_text(10, 60, anchor = W, text = "Sun", font = ("Calibri","16"))
        objCalendar.create_text(70, 60, anchor = W, text = "Mon", font = ("Calibri","16"))
        objCalendar.create_text(130, 60, anchor = W, text = "Tue", font = ("Calibri","16"))
        objCalendar.create_text(190, 60, anchor = W, text = "Wed", font = ("Calibri","16"))
        objCalendar.create_text(250, 60, anchor = W, text = "Thu", font = ("Calibri","16"))
        objCalendar.create_text(310, 60, anchor = W, text = "Fri", font = ("Calibri","16"))
        objCalendar.create_text(370, 60, anchor = W, text = "Sat", font = ("Calibri","16"))

        objCalendar.create_text(10,20,anchor = W, text = self.__str__(), font = ("Calibri","16"))
        ...
        for count in range(1,tempDate.returnMaxDay()+1):
            if count <= 9:
                objCalendar.create_text(x, y, anchor = W, text = "  " + str(count), font = ("Calibri","16"))
            else:
                objCalendar.create_text(x, y, anchor = W, text = count, font = ("Calibri","16"))

            if count == self.day:
                objCalendar.create_oval(x - 10,y - 20,x + 30,y + 20, outline = "red",width = 3)
...
def go(firstTime = True):
    ...
    if myDate.calcValid():
        ...
        lblErrorBox = Label(window,text = "The Calendar for this date either does not exist or is no longer accurate, please enter a valid date.", \
                    font = ("Calibri","14","bold"))
        lblErrorBox.place(x = 20, y = 500)
...
# Author: Jackie Xu
# Date: 11/27/2014
# Purpose: Shows the Calendar for the previous century
# Parameters: -
# Return: -
...
def prevCentury():
    ...
    if not myDate.calcValid():
        myDate.day = myDate.returnMaxDay()
...
# Author: Jackie Xu
# Date: 11/27/2014
# Purpose: Shows the Calendar for the previous decade
# Parameters: -
# Return: -
...
# Author: Jackie Xu
# Date: 11/27/2014
# Purpose: Shows the Calendar for the previous year
# Parameters: -
# Return: -
...
# Author: Jackie Xu
# Date: 11/27/2014
# Purpose: Shows the Calendar for the previous month
# Parameters: -
# Return: -
...
# Author: Jackie Xu
# Date: 11/27/2014
# Purpose: Shows the Calendar for the instantaneous moment
# Parameters: -
# Return: -
...
# Author: Jackie Xu
# Date: 11/27/2014
# Purpose: Shows the Calendar for the next month
# Parameters: -
# Return: -
...
# Author: Jackie Xu
# Date: 11/27/2014
# Purpose: Shows the Calendar for the next year
# Parameters: -
# Return: -
...
# Author: Jackie Xu
# Date: 11/27/2014
# Purpose: Shows the Calendar for the next decade
# Parameters: -
# Return: -
...
# Author: Jackie Xu
# Date: 11/27/2014
# Purpose: Shows the Calendar for the next century
# Parameters: -
# Return: -
...
menubar.add_cascade(label = "Calendar Options", menu = startMenu)
...
objCalendar = Canvas(window, width = 450, height = 300, bg = "bisque")
objCalendar.place(x = 300, y = 120)

window.create_text(20,40,anchor = W, text = "Calendar", font = ("Calibri","40","bold"))
...
lblErrorBox = Label(window,text = "Welcome to Calendar! Plese enter a valid date to start, or click 'Today' to view today's date.", \
                    font = ("Calibri","14","bold"))
lblErrorBox.place(x = 20, y = 500)
...
cmdDisplay = Button(window, text = "Show Calendar!", width = 16, font = ("Calibri","20","bold"),command = lambda: go())
