#reference: http://stackoverflow.com/questions/7539401/gui-layout-using-tk-grid-geometry-manager

#This sample code found online does not import tkinter the same way we do in class
#as such; the prefix Tkinter has to be used for every call.  If we import
#the way presented in our notes; all of these prefixes would not be required.
